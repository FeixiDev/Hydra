...
class ConnSSH(object):
    ...
    def _connect(self):
        ...
        self.logger.write_to_log('T','DATA','value','dict','data for SSH connect',{'host':self._host,'port':self._port,'username':self._username,'password':self._password})
    ...
    def execute_command(self, command):
        self.logger.write_to_log('T','DATA','input','cmd',command)
        # [time],[transaction_id],[display],[type_level1],[type_level2],[d1],[d2],[data]
